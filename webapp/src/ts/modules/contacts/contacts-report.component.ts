  ...
  save() {
    ...
    this.formService
      ...
      .then(async (docs) => {
        ...
        // const familyDoc: any = docs.find(doc => doc.type === 'clinic');
        // if (familyDoc) {
        //   const parentDoc = await this.formService.getContactKossi(familyDoc.parent._id);
        //   const parentDocToUpdate = Object.assign({}, parentDoc);
        //   parentDocToUpdate.last_family_code = parseInt(familyDoc.external_id);
        //   parentDocToUpdate.last_patient_code = parseInt(familyDoc.external_id);
        //   await this.formService.saveContactKossi(parentDocToUpdate);
          
        //   console.log('AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA');
        //   console.log(parentDocToUpdate);
        //   console.log('AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA');

        //   this.router.navigate(['/contacts', familyDoc._id]);
        //   return;
        // }
